...
# Modifications by Rico Sennrich:
# This is a stripped down version of the NLTK Punkt sentence tokenizer
# It offers a quicker startup time and minimizes external dependencies
# The following modifications have been made:
# - language parameters are stored in module punkt_data_german instead of being pickled/unpickled
# - removed NLTK dependencies (TokenizerI, FreqDist)
# - Python 3 compatibility
# - added methods tokenize_fobj() and _slices_from_fobj to PunktSentenceTokenizer to tokenize file object instead of string
# - if this file is started as a script, it loads the German parameters and tokenizes stdin
# Note that training is not functional since nltk.probability.FreqDist is not imported
    ...
    def _find_sent_starters(self):
        ...
        for typ, typ_at_break_count in self._sent_starter_fdist.items():
            ...
            if (
                ...
                and float(self._type_fdist.N()) / self._sentbreak_count
...
class PunktSentenceTokenizer(PunktBaseClass):
    ...
    # modified version of _slices_from_text in to process file object line-by-line instead of requiring string
    def _slices_from_fobj(self, fobj):
        buf = ""
        for line in fobj:
            buf += line.strip() + " "
            last_break = 0
...
if __name__ == "__main__":
    ...
    tokenizer._params.collocations = punkt_data_german.collocations
